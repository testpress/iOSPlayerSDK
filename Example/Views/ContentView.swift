        ...
        NavigationView {
            VStack {
                Text("Sample videos")
                    .font(.title)
                    .padding()
                nonDRMNavigationLink(title: "Non-DRM-1", assetId: "BEArYFdaFbt", accessToken: "ecf6366b-c2ee-408c-9472-6ed4e4b3047e")
                nonDRMNavigationLink(title: "Non-DRM-2", assetId: "7BsJXTfb3hr", accessToken: "")
